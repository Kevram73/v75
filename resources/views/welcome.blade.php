            ...
            <div class="single-text owl-carousel">
                ...
                <div class="slide">
                    ...
                    <br><p class="mb-5 desc" data-aos="fade-up" data-aos-delay="100">Investissez dès maintenant et commencer à percevoir vos gains 24H après votre inscription et la création de votre compte d'investissement ;
                        Dépôts et retrait instantané ! <br>Transactions possible via <span class="text-success">USDT TRC20 </p>
                        {{-- </span><br>Portefeuille supporté : <span class="text-success">Trust Wallet</span> --}}
                    <div data-aos="fade-up" data-aos-delay="100">
                        <a href="{{route('client.login')}}" target="_blank" class="btn  btn-success mr-2 mb-2" style="color: white;">Commencer maintenant</a>
                    </div>
                </div>
    ...
    <section class="site-section" id="how" style="margin-top: -10%;">
        ...
        <div class="row align-items-lg-center" >
            ...
            <div class="owl-carousel slide-one-item-alt-text">
                ...
                <p style="text-align: justify; line-height: 34px;">Une fois votre investissement faite, percevez jusqu'à 3,3% de bénéfice journalier sur votre capital ; à retirer à tout moment via USDT TRC20.</p>
    ...
    <section class="site-section border-bottom bg-light" id="services-section">
        ...
        <div class="row mb-5">
            ...
            <p class="lead" data-aos="fade-up" data-aos-delay="100">Avec notre bot de trading des indices, gagnez 3.33% par jour, 100% par mois. <br>
                Minimum à investir 10$, USDT TRC20 (Dépôt et retrait instantané)</p>
            </div>
        </div>
        <div class="row align-items-stretch">
            ...
            <div class="unit-4 text-center">
                ...
                <br><p style="text-align: justify; line-height: 30px;">Faites vos dépôts d'investissement à partir de 10$ minimum via <a href="www.usdt.com" class="text-danger"> USDT TRC20</a></p>
