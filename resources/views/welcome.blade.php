    ...
    <section class="site-section testimonial-wrap" id="testimonials-section" data-aos="fade">
        ...
        <div class="slide-one-item home-slider owl-carousel">
            ...
            <div class="testimonial">
                ...
                <p style="line-height: 30px;">&ldquo; J’utilise V75 pro depuis plusieurs mois déjà et je suis impressionné par sa stabilité et sa précision sur le reversement des RSI. Je perçois mes 3,3% quotidiennement et j'ai toujours mon capital à disposition. Merci v75 pro ! &rdquo;</p>
                </blockquote>
    ...
    <section class="site-section bg-light" id="pricing-section">
        ...
        <div class="row">
            ...
            <div class="mb-5" data-aos="fade-up" data-aos-delay="100">
                ...
                Le but premier de la plateforme v75 pro est de permettre à toute personne d'investir indépendemment de sa situation géographique ; pour ce faire le seul moyen de transactions accepté par notre plateforme est : le <a href="" class="text-black"> USDT TRC20</a></p>
            </div>
            </div>
            <div class="col-lg-6">
