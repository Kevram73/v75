...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="site-section cta-big-image" id="about-section">
        ...
        <div class="row mb-5 justify-content-center">
            ...
            <h2 class="section-title mb-3 text-sucess" data-aos="fade-up" data-aos-delay="" style="color: black;">A propos de v75</h2>
        ...
        <div class="row">
            ...
            <img src="vitrine/images/img_2.jpg" alt="v75" class="img-fluid">
            </figure>
            </div>
    ...
    <div class="site-section" id="next" style="margin-top: -10%;">
        ...
        <div class="row mb-5">
            ...
            <img src="vitrine/images/flaticon-svg/svg/001-wallet.svg" alt="v75" class="img-fluid w-25 mb-4">
            ...
            <img src="vitrine/images/flaticon-svg/svg/004-cart.svg" alt="v75" class="img-fluid w-25 mb-4">
            ...
            <img src="vitrine/images/flaticon-svg/svg/006-credit-card.svg" alt="v75" class="img-fluid w-25 mb-4">
        ...
        <div class="row">
            <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            <figure class="circle-bg">
            <img src="vitrine/images/about_2.jpg" alt="v75" class="img-fluid">
            </figure>
            </div>
            <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
            <div class="mb-4">
                <h3 class="h3 mb-4 text-black"><span class="text-success">$ Investir autrement</span></h3>
                <p>Avec la plateforme v75, votre capital n'a jamais été un aussi bon employé à votre compte.</p>
    ...
    <section class="site-section" id="how" style="margin-top: -10%;">
        ...
        <div class="row mb-5 justify-content-center">
            ...
            <p class="lead" data-aos="fade-up" data-aos-delay="100">Avec V75 investir n'a jamais été aussi facile. <br>Tout en trois (03) étapes</p>
            </div>
        </div>
        ...
        <div class="row align-items-lg-center" >
            ...
            <div class="owl-carousel slide-one-item-alt-text">
                ...
                <p style="text-align: justify; line-height: 34px;">Créer votre compte d'investissement v75 en fournissant les informations utiles ; puis se connecter ! <br>Accéder à votre tableau de bord et commencez à investir.</p>
                ...
                <p style="text-align: justify; line-height: 34px;">Une fois votre investissement faite, percevez jusqu'à 3,3% de bénéfice journalier sur votre capital ; à retirer à tout moment via Dollar perfect money, USDT TRC20.</p>
    ...
    <section class="site-section border-bottom bg-light" id="services-section">
        ...
        <div class="row mb-5">
            ...
            <p class="lead" data-aos="fade-up" data-aos-delay="100">Avec notre bot de trading des indices, gagnez 3.33% par jour, 100% par mois. <br>
                Minimum à investir 10$, Dollar perfect money, USDT TRC20 (Dépôt et retrait instantané)</p>
            </div>
        </div>
        <div class="row align-items-stretch">
            ...
            <div class="unit-4 text-center">
                ...
                <br><p style="text-align: justify; line-height: 30px;">Investir n'a jamais été aussi simple avec v75. Créez votre compte d'investissement v75, connectez-vous et accédez à votre dashboard pour commencer à opérer.</p>
            ...
            <div class="unit-4 text-center">
                <div class="unit-4-icon">
                <img src="vitrine/images/flaticon-svg/svg/002-rich.svg" alt="v75" class="img-fluid w-25 mb-4">
                </div>
                <div>
                <h3 style="line-height: 30px;">Faites vos placements <br>investissz dès 10$</h3>
                <br><p style="text-align: justify; line-height: 30px;">Faites vos dépôts d'investissement à partir de 10$ minimum via <a href="" class="text-danger">Dollar perfect money</a> et <a href="" class="text-danger"> USDT TRC20</a> (Capital/Mise initiale retirable à tout moment de la plateforme).</p>
            ...
            <div class="unit-4 text-center">
                <div class="unit-4-icon">
                <img src="vitrine/images/flaticon-svg/svg/003-notes.svg" alt="v75" class="img-fluid w-25 mb-4">
                </div>
                <div>
    ...
    <section class="site-section bg-light" id="pricing-section">
        ...
        <div class="row">
            ...
            <div class="mb-5" data-aos="fade-up" data-aos-delay="100">
                ...
                <p style="line-height: 32px; text-align: justify;">Oui ! La plateforme v75 est ouverte à tout le monde, accessible partout dans le monde et destinée à toute personne désireux d'investir ou placer ses fonds à trader.</p>
            </div>
    ...
    <section class="site-section" id="about-section">
        ...
        <div class="row">
            <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            <figure class="circle-bg">
            <img src="vitrine/images/img_4.jpg" alt="v75" class="img-fluid">
            </figure>
            </div>
            <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row">
                ...
                <div class="unit-4 d-flex">
                    ...
                    <p style="line-height: 30px; text-align: justify;">D'un point de vue jurique, il s’agit d’un accord entre la plateforme V75 et vous (Souscripteur et utilisateur de v75). En utilisant la plateforme, vous acceptez d'avoir lu, compris et accepté toutes les conditions générales contenues dans les présentes (le «Contrat d'utilisation»), ainsi que notre politique de confidentialité disponible <a href="/policy" class="text-danger"> ici</a></p>
    ...
    <section class="site-section bg-light" id="contact-section" data-aos="fade">
        ...
        <div class="row mb-5">
            ...
            <p class="mb-4">
                ...
                <span>Siège officiel V75, <br>Dubaï</span>
            </p>
            </div>
            <div class="col-md-4 text-center">
            <p class="mb-4">
            ...
            <p class="mb-0">
                ...
                <a href="#" class="text-success">info@v75.net</a>
            </p>
            </div>
        </div>
        <div class="row">
