                    ...
                    <div class="modal-content modal-filled bg-info">
                        <div class="modal-body p-4">
                            <div class="text-center" style="color: white; font-size:15px;">
                                ...
                                <p class="mt-3" style="text-align: center;">Souhaitez vous désactiver le compte de ce client, le retirer de la plateforme ?<br>Son statut sera inactif !</p>
                                <button type="submit" class="btn btn-light my-2" data-bs-dismiss="modal">Retirer</button>
                            </div>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
