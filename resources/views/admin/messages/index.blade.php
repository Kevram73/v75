        ...
        <div class="row">
          ...
          <div class="col-12">
              ...
              <div class="box-header with-border">
                <h2 class="box-title text-info" style="font-weight: 500">Liste des messages</h2>
                    ...
                    <table id="example" class="table text-fade table-bordered table-hover display nowrap margin-top-10 w-p100">
                      ...
                      <tbody>
                        @foreach ($messages as $message)
                            <tr>
                                <td class="text-dark">{{$message->lastname}}</td>
                                ...
                                <td>
                                    <a href="">
                                        <button class="btn btn-info-light ms-1" id="request" title="Editer le message">Modifier</button>
                                    </a>
                                    <a href="">
					                    <button class="btn btn-danger-light ms-1" id="exit" title="Supprimer le message">Supprimer</button>
                                    </a>
