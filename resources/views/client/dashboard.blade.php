            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-12">
                    <div class="box">
                      ...
                      <div class="box-body">
                        <p class="text-gray-600"><marquee behavior="" direction="left">Gagnez 3,33% par jour, 100% par mois avec notre bot de trading des indices. Minimum à investir 10$ ; transactions via <span class="text-success"> USDT TRC20,</span> Portefeuille supporté : <span class="text-success">Trust Wallet</span>. Dépôt et retrait instantané. Avec v75 pro, c'est votre argent qui travaille pour vous !</marquee></p>
