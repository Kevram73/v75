							...
							<div class="p-30">
								...
								<br><form method="POST" action="{{ route('client.auth_register') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent" style="border: 1px solid rgba(1, 17, 0, 0.11); color:black;"><i class="text-fade ti-user"></i></span>
                                            <input type="text" id="fellow" name="fellow" class="form-control ps-15 bg-transparent" placeholder="Code de parrainage (optionnel)" value="" readonly disabled style="border: 1px solid rgba(0, 91, 0, 0.089); color:black;">
                                        </div>
									</div>
									<div class="form-group">
										<div class="input-group mb-3">
