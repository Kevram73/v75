...
<head>
    ...
    <title>V75 Pro Client - Connexion</title>
...
<body class="bg-gray-50">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 p-10 bg-white rounded-lg shadow-lg border border-gray-200">
            ...
            <form class="mt-8 space-y-6" action="{{ route('client.auth_login') }}" method="POST">
                @csrf
                ...
                <div class="flex items-center justify-between">
                    <div class="text-sm">
                        <a href="{{ route('client.password.request') }}" class="font-medium text-green-600 hover:text-green-500">
                            Mot de passe oublié ?
                        </a>
                    </div>
                </div>
            ...
            <div class="text-center text-sm text-gray-600">
                ...
                <a href="{{ route('client.register') }}" class="font-medium text-green-600 hover:text-green-500">
                    Créer un compte
                </a>
            </div>
        </div>
