    ...
    <section class="sidebar position-relative">
		  ...
		  <div class="multinav-scroll" style="height: 97%;">
			  ...
			  <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <ul class="treeview-menu">
                      <li>
                          <a href="{{route('admin.deposits')}}">
                              <i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Liste des dépôts
                              <span class="pull-right-container">
                              </span>
                          </a>
                      </li>
                      <li>
                          <a href="{{route('admin.withdrawals')}}">
                              <i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Liste des retraits
                              <span class="pull-right-container">
                              </span>
                          </a>
                      </li>
                      <li>
                        <a href="{{route('admin.transactions')}}">
                            <i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Liste des transactions
                            <span class="pull-right-container">
                            </span>
                        </a>
                    </li>
                ...
                <li>
                    <a href="{{route('retrieve_manage')}}">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                      <span>Demande de retraits</span>
                      <span class="pull-right-container">
                      </span>
                    </a>
			  ...
			  <div class="sidebar-widgets">
				  <div class="mx-25 mb-30 pb-20 side-bx bg-info-light rounded20">
					<div class="text-center">
						<img src="{{asset('/images/svg-icon/color-svg/custom-32.svg')}}" class="sideimg p-5" alt="">
